...
file_path = '../../data/raw/2018.csv'  # Update this path to the location of your file
...
output_file_path = '../../data/interim/2018.csv'  # Update this path to where you want to save the file
