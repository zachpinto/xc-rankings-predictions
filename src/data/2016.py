...
parsed_df_v8 = df[0].apply(parse_row_v8)

# Rename the columns
parsed_df_v8.columns = ['Name', 'Grade', 'School', 'Time']

# Remove rows where 'Grade' is None since those are unparsed rows
parsed_df_v8 = parsed_df_v8.dropna(subset=['Grade'])

# Save the cleaned dataframe to a new CSV file
output_file_path = '../../data/interim/2016.csv'  # Path to save the cleaned file
parsed_df_v8.to_csv(output_file_path, index=False, encoding='utf-8')
