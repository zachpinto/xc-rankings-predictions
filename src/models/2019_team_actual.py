...
# Load the actual 2019 race results
file_path = '../../reports/2019_race_actual.csv'  # Update this path to the location of your actual race results file
...
output_file_path = '../../reports/2019_team_actual.csv'  # Update this path to where you want to save the file
team_stats.to_csv(output_file_path, index=False)

print("2019 team actuals are saved.")
